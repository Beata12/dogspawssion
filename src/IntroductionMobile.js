					...
					<div className="row">
						...
						<Collapse isOpened={elemToDisplay === 1}>
							...
							<div className="intro-txt-info">
								...
								kwalifikacje, biorąc udział w kursach i
								webinarach. Swoją przyszłość wiążę ze
								zwierzętami. Chce pomagać psom oraz ich
								opiekunom oraz szerzyć wiedzę o prawidłowym ich
								karmieniu, trenowaniu oraz, przede wszystkim
								wychowaniu.
								<br />
								<br />
								Pragnę aby wszystkie psy oraz ich opiekunowie
								byli szczęśliwi. Psy doskonale odczytują naszą
								mowę ciała, nasze gesty oraz emocje. W drugą
								stronę niestety jest trochę gorzej. Moim
								zadaniem, jest ukierunkowanie opiekunów na dobrą
								ścieżkę oraz pokazanie im, że poprzez
								zrozumienie psiego języka uszanowanie psich
								potrzeb można stworzyć silną więź pomiędzy psem
								a jego opiekunami i rozwiązać wszelkie problemy,
							...
							<ul>
								<li>
									...
									<ul>
										...
										<li>Nr licencji: 349/1/dogo/gw/2018</li>
									</ul>
								</li>
								...
								<li>
									...
									<ul>
										...
										<li>
											Nr licencji: 542/TRP/GW/PAZiA/2021
										</li>
										<li></li>
									</ul>
								</li>
