...
function TestimonialMobile() {
	return (
		<div className="container-mobile-testimonial">
			<div>
				<h1 className="think-text">CO INNI O MNIE MYŚLĄ?</h1>
			</div>
			<div className="testimonial-container">
				...
				>
					<div className="row">
						<div className="testim-name col-4">Karolina</div>
						<div className="col-8">
							<img
				...
				>
					<div className="row">
						<div className="testim-name col-4 ">Kamila</div>
						<div className="col-8">
							<img
				...
				>
					<div className="row">
						<div className="col-4 testim-name">Paweł</div>
						<div className="col-8">
							<img
